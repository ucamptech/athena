...
class ExerciseServices {
  ...
  static const String _baseUrl = "http://10.0.2.2:3000/api/exercises";
  static const Map<String, String> _headers = {
    'Content-Type': 'application/json',
  };

  Future <bool> createExerciseData({ required Map<String, dynamic> data }) async {
...
Future <List<Map<String, dynamic>>> getExerciseData() async {
...
Future <void> updateExerciseData(Map<String, dynamic> data, int id) async {
  final body = jsonEncode(data);
